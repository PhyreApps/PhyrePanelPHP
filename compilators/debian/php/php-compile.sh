...
PACKAGE_MAIN_DIR=$MAIN_DIR/phyre-php-8.2.0-$1
...
sudo dpkg --info $MAIN_DIR/phyre-php-8.2.0-$1.deb
sudo dpkg --contents $MAIN_DIR/phyre-php-8.2.0-$1.deb

# Move debian package to dist folder
sudo mkdir -p $MAIN_DIR/dist
sudo mv $MAIN_DIR/phyre-php-8.2.0-$1.deb $MAIN_DIR/dist
